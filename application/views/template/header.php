...
<html lang="es">
  <head>
    ...
    <!-- Datatables Css -->
    <link href="<?= base_url('assets/css/plugins/DataTables-1.10.15/jquery.dataTables.min.css') ?>">
    <link href="<?= base_url('assets/css/plugins/DataTables-1.10.15/dataTables.bootstrap.css') ?>">      
    ...
    <nav class="navbar navbar-default">
      <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="#"><a href="<?= site_url() ?>"><img height="44" title="CodeIgniter Logo"
